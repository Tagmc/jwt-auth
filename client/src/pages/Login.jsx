...
import EmHuyTapCodeIcon from '../assets/EmHuyTapCode-logo.png'
...
function Login() {
  ...
  return (
    <Box sx={{
      ...
      background: 'url("src/assets/EmHuyTapCode-bg-img.jpeg")',
        ...
        <Zoom in={true} style={{ transitionDelay: '200ms' }}>
          <MuiCard sx={{ minWidth: 380, maxWidth: 380, marginTop: '6em', p: '0.5em 0', borderRadius: 2 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', color: theme => theme.palette.grey[500] }}>
              <Box>
                <Typography>Hint: EmHuyTapCode.official@gmail.com</Typography>
